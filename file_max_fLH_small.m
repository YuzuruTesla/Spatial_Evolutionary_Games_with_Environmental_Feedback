%Script used to generate Figure 7(d) based on file average_max_f_small.csv

% Load the data from average_max_f_small.csv
data = load('average_max_f_small.csv'); 
...
% Plot for max f_L and f_H (Figure 7(d))
figure;
hold on;
dotSize = 80;
